        ...
        <div className='w-full'>
            ...
            <div className='w-[80%] my-12 mx-auto'>
                ...
                <div className='flex items-center hover:bg-opacity-5 hover:bg-primary cursor-pointer'>
                    ...
                    <div className=' w-[40%] flex gap-x-4 items-center  px-  py-6 cursor-pointer '>
                    ...
                    <div className=' w-[40%] flex gap-x-4 items-center  px-  py-6 cursor-pointer '>
                        ...
                        <div className=''>
                            <p className='text-sm flex font-light items-center cursor-pointer hover:text-primary'>siteurl.porto.com <span className='text-sm' ><CgExternal />
                            </span>
                            </p>
                        </div>
                    </div>
